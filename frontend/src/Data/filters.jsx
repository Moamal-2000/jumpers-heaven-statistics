export const FILTERS_COMPONENTS_DATA = [
  ...
  },
  {
    ...
    filtersData: [
      ...
      { text: "NA", queryValue: "North America", id: 2 },
      { text: "EU", queryValue: "Europe", id: 3 },
      { text: "AS", queryValue: "Asia", id: 4 },
      { text: "OC", queryValue: "Oceania", id: 5 },
      { text: "SA", queryValue: "South America", id: 6 },
      { text: "AF", queryValue: "Africa", id: 7 },
    ],
    id: 3,
  },
  {
