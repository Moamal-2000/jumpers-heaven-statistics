              ...
              <div className={s.teamGrid} role="list">
                <div className={s.teamMember} role="listitem">
                  ...
                  <p className={s.memberDescription}>
                    Did the backend and worked on the frontend development of
                ...
                <div className={s.teamMember} role="listitem">
                  ...
                  <p className={s.memberDescription}>
                    Worked on the frontend development of the leaderboard
                    platform.
                  </p>
                </div>
              </div>
              ...
              <div className={s.techGrid}>
                <div className={s.techItem}>
                  ...
                  <p className={s.techDescription}>
                    Our project operates independently from JumpersHeaven. We
                    simply retrieve and display data from their database without
                    any direct affiliation or dependency on their systems.
                  </p>
                </div>
                ...
                <div className={s.techItem}>
                  ...
                  <p className={s.techDescription}>
                    All leaderboard data is sourced from the JumpersHeaven
                    database with permission from Iznogod. We maintain data
                    integrity while providing enhanced visualization and user
                    experience.
                  </p>
                </div>
          ...
          <section className={s.section}>
            ...
            <div className={s.card}>
              <p className={s.description}>
                ...
                competitive jumper, our platform helps you track your progress
                and compare your achievements with others.
              </p>
              <p className={s.description}>
